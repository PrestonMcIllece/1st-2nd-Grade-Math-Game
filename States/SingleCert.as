package States
{
	...
	public class SingleCert extends Sprite implements IState
	{
		//INSTANCE VARIABLES
		 ...
		 */
		public function SingleCert(game:Game)
		{
			this.game = game;
		...
		private function init(event:Event):void
		{
			...
			//fname = MyPlayer.getfname();
			//lname = MyPlayer.getlname();
			...
			cert = new Button(Assets.ta2.getTexture("single"), "\n" + name);
