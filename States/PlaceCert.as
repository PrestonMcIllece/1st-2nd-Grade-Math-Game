package States
{
	...
	public class PlaceCert extends Sprite implements IState
	{
		//INSTANCE VARIABLES
		 ...
		 */
		public function PlaceCert(game:Game)
		{
			this.game = game;
		...
		private function init(event:Event):void
		{
			...
			cert = new Button(Assets.ta2.getTexture("place"), "\n" + name); //switch to name to check Flox
